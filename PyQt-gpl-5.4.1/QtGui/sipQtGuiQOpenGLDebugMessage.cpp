...
#line 29 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtGui/sipQtGuiQOpenGLDebugMessage.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtGui/sipQtGuiQOpenGLDebugMessage.cpp"
...
static sipEnumMemberDef enummembers_QOpenGLDebugMessage[] = {
    {sipName_APISource, static_cast<int>(QOpenGLDebugMessage::APISource), 132},
    {sipName_AnySeverity, static_cast<int>(QOpenGLDebugMessage::AnySeverity), 131},
    {sipName_AnySource, static_cast<int>(QOpenGLDebugMessage::AnySource), 132},
    {sipName_AnyType, static_cast<int>(QOpenGLDebugMessage::AnyType), 134},
    {sipName_ApplicationSource, static_cast<int>(QOpenGLDebugMessage::ApplicationSource), 132},
    {sipName_DeprecatedBehaviorType, static_cast<int>(QOpenGLDebugMessage::DeprecatedBehaviorType), 134},
    {sipName_ErrorType, static_cast<int>(QOpenGLDebugMessage::ErrorType), 134},
    {sipName_GroupPopType, static_cast<int>(QOpenGLDebugMessage::GroupPopType), 134},
    {sipName_GroupPushType, static_cast<int>(QOpenGLDebugMessage::GroupPushType), 134},
    {sipName_HighSeverity, static_cast<int>(QOpenGLDebugMessage::HighSeverity), 131},
    {sipName_InvalidSeverity, static_cast<int>(QOpenGLDebugMessage::InvalidSeverity), 131},
    {sipName_InvalidSource, static_cast<int>(QOpenGLDebugMessage::InvalidSource), 132},
    {sipName_InvalidType, static_cast<int>(QOpenGLDebugMessage::InvalidType), 134},
    {sipName_LowSeverity, static_cast<int>(QOpenGLDebugMessage::LowSeverity), 131},
    {sipName_MarkerType, static_cast<int>(QOpenGLDebugMessage::MarkerType), 134},
    {sipName_MediumSeverity, static_cast<int>(QOpenGLDebugMessage::MediumSeverity), 131},
    {sipName_NotificationSeverity, static_cast<int>(QOpenGLDebugMessage::NotificationSeverity), 131},
    {sipName_OtherSource, static_cast<int>(QOpenGLDebugMessage::OtherSource), 132},
    {sipName_OtherType, static_cast<int>(QOpenGLDebugMessage::OtherType), 134},
    {sipName_PerformanceType, static_cast<int>(QOpenGLDebugMessage::PerformanceType), 134},
    {sipName_PortabilityType, static_cast<int>(QOpenGLDebugMessage::PortabilityType), 134},
    {sipName_ShaderCompilerSource, static_cast<int>(QOpenGLDebugMessage::ShaderCompilerSource), 132},
    {sipName_ThirdPartySource, static_cast<int>(QOpenGLDebugMessage::ThirdPartySource), 132},
    {sipName_UndefinedBehaviorType, static_cast<int>(QOpenGLDebugMessage::UndefinedBehaviorType), 134},
    {sipName_WindowSystemSource, static_cast<int>(QOpenGLDebugMessage::WindowSystemSource), 132},
};
