...
#include <qtextobject.h>
#line 31 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtGui/sipQtGuiQTextBlockiterator.cpp"

#line 235 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/sip/QtGui/qtextobject.sip"
#include <qtextobject.h>
#line 35 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtGui/sipQtGuiQTextBlockiterator.cpp"
...
static PyObject *slot_QTextBlock_iterator___isub__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        {
#line 176 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)--;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)++;
#line 120 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtGui/sipQtGuiQTextBlockiterator.cpp"
...
static PyObject *slot_QTextBlock_iterator___iadd__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1i", &a0))
        {
#line 166 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)++;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)--;
#line 167 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtGui/sipQtGuiQTextBlockiterator.cpp"
