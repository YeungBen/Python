...
#line 29 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtPrintSupport/sipQtPrintSupportQPrintEngine.cpp"

#line 28 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/sip/QtPrintSupport/qprinter.sip"
#include <qprinter.h>
#line 33 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtPrintSupport/sipQtPrintSupportQPrintEngine.cpp"
#line 26 "sip/QtGui/qpaintdevice.sip"
#include <qpaintdevice.h>
#line 36 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtPrintSupport/sipQtPrintSupportQPrintEngine.cpp"
#line 30 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 39 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtPrintSupport/sipQtPrintSupportQPrintEngine.cpp"
...
static sipEnumMemberDef enummembers_QPrintEngine[] = {
    {sipName_PPK_CollateCopies, static_cast<int>(QPrintEngine::PPK_CollateCopies), 10},
    {sipName_PPK_ColorMode, static_cast<int>(QPrintEngine::PPK_ColorMode), 10},
    {sipName_PPK_CopyCount, static_cast<int>(QPrintEngine::PPK_CopyCount), 10},
    {sipName_PPK_Creator, static_cast<int>(QPrintEngine::PPK_Creator), 10},
    {sipName_PPK_CustomBase, static_cast<int>(QPrintEngine::PPK_CustomBase), 10},
    {sipName_PPK_CustomPaperSize, static_cast<int>(QPrintEngine::PPK_CustomPaperSize), 10},
    {sipName_PPK_DocumentName, static_cast<int>(QPrintEngine::PPK_DocumentName), 10},
    {sipName_PPK_Duplex, static_cast<int>(QPrintEngine::PPK_Duplex), 10},
    {sipName_PPK_FontEmbedding, static_cast<int>(QPrintEngine::PPK_FontEmbedding), 10},
    {sipName_PPK_FullPage, static_cast<int>(QPrintEngine::PPK_FullPage), 10},
    {sipName_PPK_NumberOfCopies, static_cast<int>(QPrintEngine::PPK_NumberOfCopies), 10},
    {sipName_PPK_Orientation, static_cast<int>(QPrintEngine::PPK_Orientation), 10},
    {sipName_PPK_OutputFileName, static_cast<int>(QPrintEngine::PPK_OutputFileName), 10},
    {sipName_PPK_PageMargins, static_cast<int>(QPrintEngine::PPK_PageMargins), 10},
    {sipName_PPK_PageOrder, static_cast<int>(QPrintEngine::PPK_PageOrder), 10},
    {sipName_PPK_PageRect, static_cast<int>(QPrintEngine::PPK_PageRect), 10},
    {sipName_PPK_PageSize, static_cast<int>(QPrintEngine::PPK_PageSize), 10},
    {sipName_PPK_PaperName, static_cast<int>(QPrintEngine::PPK_PaperName), 10},
    {sipName_PPK_PaperRect, static_cast<int>(QPrintEngine::PPK_PaperRect), 10},
    {sipName_PPK_PaperSize, static_cast<int>(QPrintEngine::PPK_PaperSize), 10},
    {sipName_PPK_PaperSource, static_cast<int>(QPrintEngine::PPK_PaperSource), 10},
    {sipName_PPK_PaperSources, static_cast<int>(QPrintEngine::PPK_PaperSources), 10},
    {sipName_PPK_PrinterName, static_cast<int>(QPrintEngine::PPK_PrinterName), 10},
    {sipName_PPK_PrinterProgram, static_cast<int>(QPrintEngine::PPK_PrinterProgram), 10},
    {sipName_PPK_Resolution, static_cast<int>(QPrintEngine::PPK_Resolution), 10},
    {sipName_PPK_SelectionOption, static_cast<int>(QPrintEngine::PPK_SelectionOption), 10},
    {sipName_PPK_SupportedResolutions, static_cast<int>(QPrintEngine::PPK_SupportedResolutions), 10},
    {sipName_PPK_SupportsMultipleCopies, static_cast<int>(QPrintEngine::PPK_SupportsMultipleCopies), 10},
    {sipName_PPK_WindowsPageSize, static_cast<int>(QPrintEngine::PPK_WindowsPageSize), 10},
};
