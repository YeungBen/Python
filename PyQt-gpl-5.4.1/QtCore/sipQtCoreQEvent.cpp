...
#line 29 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtCore/sipQtCoreQEvent.cpp"
...
static sipEnumMemberDef enummembers_QEvent[] = {
    ...
    {sipName_ContentsRectChange, static_cast<int>(QEvent::ContentsRectChange), 54},
    ...
    {sipName_MacSizeChange, static_cast<int>(QEvent::MacSizeChange), 54},
    ...
    {sipName_NonClientAreaMouseButtonDblClick, static_cast<int>(QEvent::NonClientAreaMouseButtonDblClick), 54},
    {sipName_NonClientAreaMouseButtonPress, static_cast<int>(QEvent::NonClientAreaMouseButtonPress), 54},
    {sipName_NonClientAreaMouseButtonRelease, static_cast<int>(QEvent::NonClientAreaMouseButtonRelease), 54},
    {sipName_NonClientAreaMouseMove, static_cast<int>(QEvent::NonClientAreaMouseMove), 54},
    {sipName_None_, static_cast<int>(QEvent::None), 54},
    ...
    {sipName_ThreadChange, static_cast<int>(QEvent::ThreadChange), 54},
