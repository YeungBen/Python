...
#include <qsysinfo.h>
#line 29 "/home/youngben/Gitproject/Python/PyQt-gpl-5.4.1/QtCore/sipQtCoreQSysInfo.cpp"
...
static sipEnumMemberDef enummembers_QSysInfo[] = {
    {sipName_BigEndian, static_cast<int>(QSysInfo::BigEndian), 230},
    {sipName_ByteOrder, static_cast<int>(QSysInfo::ByteOrder), 230},
    {sipName_LittleEndian, static_cast<int>(QSysInfo::LittleEndian), 230},
    {sipName_WordSize, static_cast<int>(QSysInfo::WordSize), 231},
};
